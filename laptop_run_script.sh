...
$1 run_models.py 5 ./data/splits/ ./results/augmentation/no_additional_targets/no_threshold_lm$k ./model_configs/standard Laptop $log_fp --augmented_data_fp $augmented_data_path
done
...
$1 run_models.py 5 ./data/splits/ ./results/augmentation/no_additional_targets/threshold_lm$k ./model_configs/standard Laptop $log_fp --augmented_data_fp $augmented_data_path
done
...
$1 run_models.py 5 ./data/splits/ ./results/augmentation/no_additional_targets/no_threshold_embedding$k ./model_configs/standard Laptop $log_fp --augmented_data_fp $augmented_data_path
done
...
$1 run_models.py 5 ./data/splits/ ./results/augmentation/no_additional_targets/threshold_embedding$k ./model_configs/standard Laptop $log_fp --augmented_data_fp $augmented_data_path
done
